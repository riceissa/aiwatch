create table organization_documents (
  ...
  document_scope enum('Job application experience', 'Hiring-related notice', 'Successful hire', 'Employee departure', 'Job experience', 'Job market commentary', 'HR controversy', 'Organizational growth introspection', 'New baord member notice', 'Board member departure', 'Third-party commentary on organization', 'Organizational mistake postmortem'),
