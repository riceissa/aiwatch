...
insert into people(person, country, facebook_username, github_username, linkedin_username, lesswrong_username, agentfoundations_username, website, urls, notes) values
    ...
    ,('Vanessa Kosoy',NULL,'100008748870106',NULL,'vadim-kosoy-bb590a1','Squark','7',NULL,NULL,NULL)
    ...
    ,('Ram Rachum', 'Israel', NULL, 'cool-RR', 'ram-rachum-349b7a17', 'ram-rachum', NULL, 'https://r.rachum.com', NULL, 'Research in Multi-Agent Reinforcement Learning, and Rebellion and Disobedience in AI');
