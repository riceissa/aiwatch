insert into organization_documents(url, title, publication_date, modified_date, author, publisher, affected_organizations, affected_people, document_scope, cause_area, notes) values
    (
        'https://www.openphilanthropy.org/blog/new-job-opportunities', /* url */
        'New Job Opportunities', /* title */
    ...
    ,(
        ...
        'Reflections on Our 2018 Generalist Research Analyst Recruiting', /* title */
    ...
    ,(
        'https://forum.effectivealtruism.org/posts/YCAEbRFT8pha3JiXZ/hi-i-m-holden-karnofsky-ama-about-jobs-at-open-philanthropy', /* url */
        'Hi, I’m Holden Karnofsky. AMA about jobs at Open Philanthropy', /* title */
    ...
    ,(
        'https://forum.effectivealtruism.org/posts/jmbP9rwXncfa32seH/after-one-year-of-applying-for-ea-jobs-it-is-really-really#comments', /* url */
        'After one year of applying for EA jobs: It is really, really hard to get hired by an EA organisation', /* title */
        '2019-02-25', /* publication_date */
        NULL, /* modified_date */
        'EA applicant', /* author */
    ...
    ,(
        'https://forum.effectivealtruism.org/posts/jmbP9rwXncfa32seH/after-one-year-of-applying-for-ea-jobs-it-is-really-really#Aic5bcvLmunfhmnhr', /* url */
    ...
    ,(
        'https://forum.effectivealtruism.org/posts/jmbP9rwXncfa32seH/after-one-year-of-applying-for-ea-jobs-it-is-really-really#8Sc9BRgbPQM7xSxTv', /* url */
        'Comment on After one year of applying for EA jobs: It is really, really hard to get hired by an EA organisation', /* title */
        '2019-02-28', /* publication_date */
        NULL, /* modified_date */
        'Luke Muehlhauser', /* author */
        'Effective Altruism Forum', /* publisher */
        'Open Philanthropy', /* affected_organizations */
    ...
    ,(
        ...
        'Jacob Steinhardt, Graduate Student in Artificial Intelligence, Stanford University and Science Advisor, Open Philanthropy Project', /* title */
        '2015-08-19', /* publication_date */
        NULL, /* modified_date */
        'Jacob	Steinhardt and Luke	Muehlhauser', /* author */
        'Open Philanthropy', /* publisher */
        'Open Philanthropy', /* affected_organizations */
        NULL, /* affected_people */
