create table positions(
    ...
    cause_area enum('AI safety','Global health and poverty','Effective altruism','Animal welfare','Cause prioritization', 'Forecasting', 'Longevity', 'Longtermism', 'Politics', 'Suffering-focused ethics'),
