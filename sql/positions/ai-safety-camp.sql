...
', NULL, NULL, NULL, NULL, 'AI safety') /*Reviewed on 2023-11-11*/ /*current position*/
    ...
    ,('Remmelt Ellen', 'AI Safety Camp', 'Program Coordinator', '2020-09-01', 'month', NULL, NULL, 'https://www.linkedin.com/in/remmelt-ellen-19b88045/?originalSubdomain=nl', 'Virtual', NULL, NULL, NULL, 'AI safety') /*Reviewed on 2023-11-11*/ /*current position*/
...
→ AI Safety Research Program: UK/CZ  (Oct 2019)
 A spin-off for participants further advanced in their research career. 
→ See organizers.
→ See research summaries.
#2. Physical
Prague  (Oct 2018)
