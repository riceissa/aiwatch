...
insert into products(product_name, creator, creator_type, creation_date, creation_date_precision, url, description) values
    ...
    ,('AGI Safety Solutions Map','Alexey Turchin','person','2015-01-01','year','http://immortality-roadmap.com/aisafety.pdf','A flowchart on potential solutions to AI safety. There is an accompanying post on LessWrong at <http://lesswrong.com/lw/mid/agi_safety_solutions_map/>.')
