...
insert into products(name, creation_date, creation_date_precision, url, description) values
    ...
    ,('Cause prioritization app','2016-05-18','day','http://mdickens.me/causepri-app/','An interactive app for quantitative cause prioritization. The app includes a section <http://mdickens.me/causepri-app/#7> on AI safety intervention. The creation date is the date of the first commit in the Git repository <https://github.com/bshlgrs/mega-michael-madness/commits/master?after=36ca2544a46e109ae68da6d2db054b9e728a99b5+104>.')
;
